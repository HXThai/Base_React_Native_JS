...
export default useMockSpeak = ({learnLanguage}) => {
  ...
  useEffect(() => {
    (async () => {
      ...
      try {
        ...
        // let z = await Storage.getValue('speakData');
        // if (z) {
        //   z = JSON.parse(z);
        //   console.log('have data in storage, use it', z);
      ...
      // Storage.setValue('speakData', result);
      setData(result);
      setIsLoading(false);
    })();
  }, []);
